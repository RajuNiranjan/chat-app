        ...
        <div className="w-full lg:w-1/2 bg-white p-8 lg:p-16 relative z-10">
          ...
          <div className="relative z-10">
            ...
            <div className="space-y-4">
              <Link
                to="/login"
                className="block w-full py-4 px-6 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl font-semibold text-center hover:from-indigo-700 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
              >
                Sign In
              </Link>
              <Link
                to="/signup"
                className="block w-full py-4 px-6 bg-white border-2 border-indigo-500 text-indigo-600 rounded-xl font-semibold text-center hover:bg-indigo-50 transition-all duration-300"
              >
                Create Account
              </Link>
            </div>
